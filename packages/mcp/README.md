...
A [Model Context Protocol](https://modelcontextprotocol.io) server for the [moticon](https://moticon-web.vercel.app/) icon library. Lets AI coding agents (Claude Code, Cursor, etc.) search the icon catalog and drop animated React icons straight into a project.
